<template>
    <div class="content">
        ...
        <div class="cards col-12 ml-auto mr-auto p-0">
            <div class="cards col-12 ml-auto mr-auto p-0" style="margin-bottom: 10px;padding: 10px!important;box-shadow:none!important;">
                <button class="infobtn mr-2" style="margin: 0!important;box-shadow:none!important;" @click="$bvModal.show('aboutAllin')">
                    Что такое ALL IN
                </button>
            </div>
            <div class="allin">
                            ...
                            <div class="col-12">
                                <div class="col-12 p-0">
                                    <div class="controlPanel">
                                        <label>Цель игры</label>
                                        <input
                                            type="number"
                                            class="form-control form"
                                            v-model="goal"
                                            @change="goal = (goal * 1).toFixed(2)"
                                        />
                                        <div class="buttons rows">
                                            <button class="amount-number" @click="goal = '2.00'">2x</button>
                                            <button class="amount-number" @click="goal = '3.00'">3x</button>
                                            <button class="amount-number" @click="goal = '5.00'">5x</button>
                                            <button class="amount-number" @click="goal = '10.00'">10x</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-3 bottom">
                            <div class="col-12">
                                <button class="noty btn-play blue mt-3 col-12" @click="play">Играть</button>
                            </div>
                            <div class="col-12 mt-2">
                                <div class="notys" v-if="noty.type !== null">
                                    <div class="noty" :class="noty.type">
                                        {{ noty.mess }}
                                    </div>
                                </div>
                            </div>
...
<script>
import AboutAllin from '../components/modals/AboutAllin'
...
export default {
    ...
    methods: {
        ...
        play() {
            this.noty = {}
            this.$root.axios.post('/allin/play', {
                goal: this.goal
            })
                .then(response => {
                    const {data} = response
    ...
    watch: {
        goal: function () {
            ...
            this.updateResult()
            this.goal = this.$valid(this.goal)
        }
    }
}
</script>
