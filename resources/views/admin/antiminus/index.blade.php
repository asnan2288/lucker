                    ...
                    <div class="tab-pane active" id="site" role="tabpanel">
                        <div class="kt-section">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label>Банк в ALL IN:</label>
                                    <input type="text" class="form-control" placeholder="" value="{{\App\Profit::query()->find(1)->bank_allin}}" name="bank_allin" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>Банк в Bubbles:</label>
                                    <input type="text" class="form-control" placeholder="" value="{{\App\Profit::query()->find(1)->bank_bubbles}}" name="bank_bubbles" />
                                </div>
                                <div class="col-lg-4">
