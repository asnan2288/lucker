<div class="tab-pane" id="site_payments" role="tabpanel">
    ...
    <div class="kt-section">
        ...
        <div class="form-group row">
            <div class="col-lg-4">
                <label>Id:</label>
                <input type="text" class="form-control" placeholder="xxxxxx" value="{{$settings->vlito_id}}" name="vlito_id" />
            </div>
            <div class="col-lg-4">
                <label>Секретный ключ:</label>
                <input type="text" class="form-control" placeholder="xxxxxxx" value="{{$settings->vlito_secret}}" name="vlito_secret" />
            </div>
        </div>
    </div>
    <!-- <div class="kt-section">
